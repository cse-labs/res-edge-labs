...
namespace MC.Middleware
{
    ...
    public static class ResultHandler
    {
        ...
        public static async Task<IActionResult> Handle<T>(Task<T> task, ILogger logger)
        {
            // log the request
            ...
            if (task == null)
            {
                logger.LogError(new ArgumentNullException(nameof(task)), "task is null in ResultHandler::Handle");
            ...
            catch (Exception ex)
            {
                ...
                logger.LogError(ex, "exception in ResultHandler::Handle");
